...
public class FlowTests {
    ...
    public void dummyTest() {
        ERFlow.ERFlowInitiator flow = new ERFlow.ERFlowInitiator(b.getInfo().getLegalIdentities().get(0));
        ...
        ERState state = b.getServices().getVaultService().queryBy(ERState.class,inputCriteria)
